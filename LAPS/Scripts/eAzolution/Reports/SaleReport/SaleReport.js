...
$(document).ready(function () {
    ...
    $("#btnSaleReport").click(function () {
        saleReportManager.SaleReportPrint();
    });

});

var saleReportManager = {
    SaleReportPrint: function () {
        debugger;
        ...
        var jsonParam = "";
        var serviceUrl = "../Reports/GenerateSaleReport/";
        AjaxManager.OpenAReport(serviceUrl, jsonParam, onFailed);
