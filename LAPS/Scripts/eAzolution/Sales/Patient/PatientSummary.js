...
var StudentSummaryHelper = {
    ...
    GeneratedStudentColumns: function () {
        ...
        { field: "Edit", title: "Edit", filterable: false, width: 30, template: '<button type="button" value="Edit" id="btnEdit" onClick="StudentSummaryHelper.clickEventForEditButton()" ><span class="k-icon k-i-search"></span></button>', sortable: false }
